...
import { View, Text, Image, StyleSheet, Dimensions, TouchableOpacity, FlatList, Platform } from 'react-native';
    ...
    if (!validProfiles.length) {
        return (
            <View style={styles.emptyContainer}>
                <Text style={styles.emptyText}>No featured profiles available</Text>
            </View>
        );
    }
