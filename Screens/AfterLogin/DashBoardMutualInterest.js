...
import { fetchMutualInterestsCount } from "../../CommonApiCall/CommonApiCall";
  ...
  useEffect(() => {
    const fetchProfiles = async () => {
      try {
        ...
        console.error("Error fetching mutual interest count:", error);
        setCount(0);
      }
    };
    fetchProfiles();
    ...
    <SafeAreaView style={styles.rootContainer} edges={["top"]}>
      ...
      >
        ...
        <View style={styles.headerCenter}>
          <Text style={styles.headerTitle}>Mutual Interest</Text>
          <Text style={styles.headerSubtitle}>{count} profiles expressed</Text>
        </View>
      </LinearGradient>
